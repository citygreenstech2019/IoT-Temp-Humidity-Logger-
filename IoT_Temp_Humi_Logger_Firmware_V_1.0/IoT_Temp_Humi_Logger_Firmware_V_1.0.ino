...
const unsigned long DisoffInterval = 18000;  // Display off after 8 Seconds
...
#define DHTPIN 4                            // DHT22 Connected to Physical Pin D4
...
DHTesp dht;
float temp=0, hum=0, bt=0;
/*|-----------------------------------------------------------------------------|
     Set Up Starts Here with Connecting to Wi-Fi and Access Point mode Functions
  |-----------------------------------------------------------------------------|*/
...
/*
  ...
  if (currentTime - previousTime >= DisoffInterval)
  {
    ...
    ESP.deepSleep(900e6);                                 // To sleep Mode for 5 Minutes
  }
}
*/
/*|-----------------------------------------------------------------------------|
